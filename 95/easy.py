...
Write a program that reads text from a file, and then outputs the
text to another file but with all the lines reversed and all the
words in each line reversed.
...
Your program would output this to "thetyger2.txt" (or whatever you
...
def main(args):
    for line in reversed(sys.stdin.read().split('\n')):
